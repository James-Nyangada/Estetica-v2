						...
						<div className="col-xl-4 col-md-12">
							<div className="sofax-footer-wrap mr-25">
								...
								<div className="sofax-social-icon">
									<ul>
										<li>
											<a target="_blank" href="https://x.com/esteticaagency">
												<svg
													width="17"
													height="18"
													viewBox="0 0 17 18"
										...
										<li>
											<a target="_blank" href="https://www.facebook.com/profile.php?id=61578190748401">
												<svg
													width="11"
													height="18"
													viewBox="0 0 11 18"
										...
										<li>
											<a target="_blank" href="https://www.instagram.com/estetica.agency/">
												<svg
													width="18"
													height="17"
													viewBox="0 0 18 17"
										...
										<li>
											<a target="_blank" href="https://www.linkedin.com/company/107781806/admin/dashboard/">
												<svg
													width="16"
													height="16"
													viewBox="0 0 16 16"
